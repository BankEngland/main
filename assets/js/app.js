...
let addr;
const sttaddr = "0xe3f67022fd108c1fe660704f4fd1d79a9b37844f";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xe3f67022fd108c1fe660704f4fd1d79a9b37844f";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://banktoken.finance/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0xe3f67022fd108c1fe660704f4fd1d79a9b37844f',
                    'symbol': 'BANK',
                    'decimals': '18',
                    'image': 'https://banktoken.finance/images/logo.png',
                },
            },
